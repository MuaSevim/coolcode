...
export function KeyboardLayerProvider({
  ...
  // Initializing the "stack" array with the "base" (home) screen
  ...
  // Single ctrl + c handler that walks the chain
  useKeyboard((key) => {
...
export function useKeyboardLayer() {
  ...
  if (!context) {
    throw new Error(
      "useKeyboardLayer must used within a KeyboardLayerProvider",
    );
  }
